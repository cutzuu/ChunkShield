...
public class EN
{
    ...
    public static void sendMessageMethod(World world, int x, int z, int y, ClickEvent copyCoords, HoverEvent<?> hoverCoords, Component primaryMessage)
    {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static Component blockPlaceCheck_alertBlockLimitReached(String playerName, Block b, ClickEvent copyCoords, HoverEvent<?> hoverCoords)
    {
    ...
    public static Component blockPlaceCheck_alertDoorLimitReached(String playerName, ClickEvent copyCoords, HoverEvent<?> hoverCoords)
    {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static Component entitySummonsCheck_EntityAlert_Named(EntityType type, int entitySummonNamedCount, ClickEvent copyCoords, HoverEvent<?> hoverCoords)
    {
    ...
    public static Component entitySummonsCheck_EntityAlert_UnNamed(EntityType type, int entitySummonUnNamedCount, ClickEvent copyCoords, HoverEvent<?> hoverCoords)
    {
    ...
    public static Component entitySummonsCheck_EntityAlert_NotRemoved(int length, ClickEvent copyCoords, HoverEvent<?> hoverCoords)
    {
    ...
    public static Component vehicleSummonsCheck_alertVehicleLimit(ClickEvent copyCoords, HoverEvent<?> hoverCoords)
    {
        return Component.text()
                .append(Component.text("■ ", NamedTextColor.RED))
                .append(Component.text("Removed ", NamedTextColor.YELLOW))
    ...
    public static Component main_AlertChunkScanRemovalSuccess(int totality, ClickEvent copyCoords, HoverEvent<?> hoverCoords)
    {
        return Component.text()
                .append(Component.text("■ ", NamedTextColor.RED))
